...
\addlinespace[0.2em]
\rowcolor{gray!45}
\textbf{Total} & & \textbf{513} & \textbf{139} & \textbf{401} & \textbf{5} & \textbf{16} & \textbf{41} & \textbf{13,370.03} \\
...
\rowcolor{gray!20}
\textbf{PS} & \textbf{Project Starting} & \textbf{50} & \textbf{80} & \textbf{0} & \textbf{0} & \textbf{0} & \textbf{0} & \textbf{2,309.33} \\ 
\rowcolor{gray!05}
