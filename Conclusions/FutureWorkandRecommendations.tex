...
\begin{enumerate} [leftmargin=0.75cm, label=\textbf{\arabic*.}]
    ...
    \begin{itemize} [leftmargin=0.75cm, label=$\bullet$]
        ...
        \item \textbf{Structured logging}: Supporting proactive monitoring of application health and early detection of issues, such as high failure rates in AI processing tasks.
