...
\begin{enumerate} [leftmargin=0.75cm, label=\textbf{\arabic*.}]
    ...
    \begin{itemize} [leftmargin=0.75cm, label=$\bullet$]
        ...
        \item \textbf{Structured logging}: Enabling advanced diagnostics for identifying errors and performance bottlenecks through queryable logs.

        \item \textbf{Creating Custom Dashboards and Alerts}: Supporting proactive monitoring of application health and early detection of issues, such as high failure rates in AI processing tasks.
    ...
    \item \textbf{Improve User Onboarding and Support}
