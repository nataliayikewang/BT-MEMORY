...
\begin{table}[H]
    ...
    \begin{tabularx}{\textwidth}{|>{\centering\arraybackslash}p{2cm}|>{\centering\arraybackslash}p{3cm}|X|}
        ...
        \hline
        OS & Office Supplies & A table, a chair, electricity, internet, and office rental. \\ \hline
...
\begin{table}[H]
    ...
    \renewcommand{\arraystretch}{1.2}
    \setlength{\arrayrulewidth}{0.8pt}
    \begin{tabularx}{\textwidth}{|>{\centering\arraybackslash}p{1.8cm}|>{\centering\arraybackslash}p{3cm}|X|}
        \hline
        \rowcolor{gray!40} 
        \textbf{Resource ID} & 
        \textbf{Resource Name} & 
        ...
        \hline
        GIT & Git & A version control tool for managing the source code repository. \\ \hline
        ...
        MCS & Microsoft  Collaboration Tools & Communication and coordination platforms: Microsoft Teams, Calendar, Outlook, and Word. \\ \hline
