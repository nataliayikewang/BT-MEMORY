    ...
    See Table \ref{table:summary-of-tasks-with-effort-dependencies-and-resources} for a summary of all defined tasks, including their identifiers, estimated effort in hours, any Finish-Start (FS) dependencies with other tasks, and the required resources. The final-to-start dependency column indicates which task must be fully completed before the task in that row can begin.
