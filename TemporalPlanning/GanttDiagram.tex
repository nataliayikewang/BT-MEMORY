...
\begin{itemize}[noitemsep]  
    ...
    \item \textbf{Dev5}, which depends on \textbf{Dev1} (beginning once the repository is created), spans most of the project duration to satisfy objective SG7 from Section 3.1, as clean code requires ongoing, extensive documentation.
\end{itemize}
