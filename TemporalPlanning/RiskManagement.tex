...
In the worst-case scenario, if the project misses the expected deadline, a selection of non-essential features, based on the MoSCoW prioritization defined in Section \ref{sec:functional-requirements}, will be deferred to the final development phase. As a result, these tasks will becompleted only if time permits. This alternative may be adopted solely with the Product Owner's approval. 
