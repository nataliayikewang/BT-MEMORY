...
\begin{figure}[H]
    ...
    \caption{Agile Methodology Diagram. Source: \cite{agile-methodology-diagram}} 
    \label{fig:agile-methodology-diagram} 
\end{figure}      
   
\begin{itemize}
\item \textbf{Sprint}: Each Agile cycle is considered a sprint, which is repeated as many 
times as needed throughout the project. A sprint is composed of four phases (see Figure \ref{fig:agile-methodology-diagram} 
