...
\begin{itemize} [leftmargin=0.75cm, noitemsep, label=$\bullet$]
    ...
    \item \textbf{Expenses}: Contain details of each individual expense uploaded by a user, including AI-extracted metadata, the command lines appearing on the receipt, and a foreign key linking to a User.
