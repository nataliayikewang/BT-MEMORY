...
A separate logical layer was created in the backend to execute automated tests. By running the \texttt{dotnet test} command, all test codes are executed, enabling continuous verification of the application. This test layer includes two types of automated tests: unit tests and integration tests.
